...
public abstract class AbstractDAO<T> {
    ...
    private void objectGen (Class<T> cls, ResultSet rs, List<T> cl) throws SQLException, NoSuchFieldException, IllegalAccessException, InstantiationException {
        ...
        while (rs.next()) {
            ...
            for (int i = 1; i <= md.getColumnCount(); i++) {
                ...
                Field f = cls.getDeclaredField(cn);
                f.setAccessible(true);
